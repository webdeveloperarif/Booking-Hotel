 ...
 * Copyright (c) 2020 Sachin N; Licensed GPLv3 */ !(function (e, t) {
    ...
    (t.prototype.init = function () {
      ...
      (t.prototype.loadContent = function (t, o, s) {
        ...
        c.s.dynamic
          ...
          : (c.$items.eq(t).attr("data-poster") &&
            ...
            c.$items.eq(t).attr("data-responsive") &&
              u(c.$items.eq(t).attr("data-responsive").split(",")),
        ...
        c.$slide
          ...
          m && m.html5 && !h && c.$slide.eq(t).addClass("lg-complete"),
          !0 === o &&
            ...
            o)
              ? (this.$slide.removeClass(
                ...
                c > 2
                  ...
                  : ((n = 0), (d = 1)),
                "prev" === i
                  ? r.$slide.eq(d).addClass("lg-next-slide")
                  : r.$slide.eq(n).addClass("lg-prev-slide"),
          ...
          setTimeout(function () {
            t.$outer.removeClass("lg-dragging"),
              e < 0 && Math.abs(e) > t.s.swipeThreshold
                ...
                : e > 0 && Math.abs(e) > t.s.swipeThreshold
                ? t.goToPrevSlide(!0)
                : 5 > Math.abs(e) && t.$el.trigger("onSlideClick.lg"),
      ...
      (s.prototype.init = function () {
        ...
        (s.prototype.fullScreen = function () {
          ...
          e(document).on(
            ...
            function () {
              o.core.$outer.toggleClass("lg-fullscreen-on");
            }
          ),
            this.core.$outer.find(".lg-fullscreen").on("click.lg", function () {
              t() ? o.exitFullscreen() : o.requestFullscreen();
            });
        }),
    ...
    (t = {
      ...
      (o.prototype.animateThumb = function (e) {
        ...
        if (this.core.s.animateThumb) {
          ...
          (this.left =
            (this.core.s.thumbWidth + this.core.s.thumbMargin) * e - 1 - t),
            ...
            this.core.lGalleryOn
              ? (o.hasClass("on") ||
                ...
                this.core.doCss() ||
                  o.animate({ left: -this.left + "px" }, this.core.s.speed))
              : this.core.doCss() || o.css("left", -this.left + "px"),
      ...
      (o.prototype.thumbkeyPress = function () {
        ...
        e(window).on("keydown.lg.thumb", function (e) {
          38 === e.keyCode
            ...
            : 40 === e.keyCode &&
              (e.preventDefault(), t.core.$outer.removeClass("lg-thumb-open"));
        });
      }),
      (o.prototype.destroy = function () {
        this.core.s.thumbnail &&
    ...
    !(function () {
      ...
      function s(t, o, s) {
        ...
        d && e(d).attr("src", e(d).attr("src").replace("&autoplay", "&noplay")),
          (i = this.core.s.dynamic
            ? this.core.s.dynamicEl[s].src
            : this.core.$items.eq(s).attr("href") ||
              this.core.$items.eq(s).attr("data-src"));
        var g = this.core.isVideo(i, s) || {};
        (g.youtube || g.vimeo || g.dailymotion || g.vk) &&
        ...
        (l.prototype.loadVideoOnclick = function (e) {
          ...
          if (
            ...
            if (e.hasClass("lg-has-video")) {
              ...
              t.core.s.dynamic
                ? c(
                    (n = t.core.s.dynamicEl[t.core.index].src),
                    (d = t.core.s.dynamicEl[t.core.index].html)
                  )
                : c(
                    (n =
                      t.core.$items.eq(t.core.index).attr("href") ||
                      t.core.$items.eq(t.core.index).attr("data-src")),
                    (d = t.core.$items.eq(t.core.index).attr("data-html"))
                  );
              var h = e.find(".lg-object");
              e.find(".lg-video").append(h),
      ...
      ((i = function (t) {
        ...
        var s = 1,
          i = function (o) {
            var s,
              i,
              l = t.core.$outer.find(".lg-current .lg-image"),
              r = (e(window).width() - l.prop("offsetWidth")) / 2,
              a =
                (e(window).height() - l.prop("offsetHeight")) / 2 +
                e(window).scrollTop();
          ...
          r = function (o, i, r, a) {
            var n,
              d,
              c = i.prop("offsetWidth");
            (d = t.core.s.dynamic
              ? t.core.s.dynamicEl[r].width || i[0].naturalWidth || c
        ...
        t.core.$slide.on("mousedown.lg.zoom", function (s) {
          ...
          e(window).on("mouseup.lg.zoom", function (e) {
            i &&
              ...
              l &&
                (o.x !== s.x || o.y !== s.y) &&
                ((s = { x: e.pageX, y: e.pageY }), t.touchendZoom(o, s, r, a)),
              (l = !1)),
              t.core.$outer.removeClass("lg-grabbing").addClass("lg-grab");
          });
      }),
      (i.prototype.touchendZoom = function (e, t, o, s) {
        var i = this.core.$slide.eq(this.core.index).find(".lg-img-wrap"),
          l = this.core.$slide.eq(this.core.index).find(".lg-object"),
          r = -Math.abs(i.attr("data-x")) + (t.x - e.x),
          a = -Math.abs(i.attr("data-y")) + (t.y - e.y),
          n =
            (this.core.$outer.find(".lg").height() - l.prop("offsetHeight")) /
            2,
          d = Math.abs(
            l.prop("offsetHeight") * Math.abs(l.attr("data-scale")) -
              this.core.$outer.find(".lg").height() +
              n
          ),
          c =
            (this.core.$outer.find(".lg").width() - l.prop("offsetWidth")) / 2,
          h = Math.abs(
            l.prop("offsetWidth") * Math.abs(l.attr("data-scale")) -
        ...
        (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) &&
          (s && (a <= -d ? (a = -d) : a >= -n && (a = -n)),
          o && (r <= -h ? (r = -h) : r >= -c && (r = -c)),
          s ? i.attr("data-y", Math.abs(a)) : (a = -Math.abs(i.attr("data-y"))),
          o ? i.attr("data-x", Math.abs(r)) : (r = -Math.abs(i.attr("data-x"))),
          this.core.s.useLeftForZoom
            ? i.css({ left: r + "px", top: a + "px" })
            : i.css("transform", "translate3d(" + r + "px, " + a + "px, 0)"));
      }),
  ...
  (function (e, t) {
    ...
    (t = { hash: !0 }),
      ((o = function (o) {
        ...
        o.core.$el.on("onAfterSlide.lg.tm", function (e, t, s) {
          ...
          e(window).on("hashchange.lg.hash", function () {
            var e = parseInt(
              (t = window.location.hash).split("&slide=")[1],
              10
            );
      ...
      (o.prototype.destroy = function () {
        this.core.s.hash &&
          (this.oldHash &&
          0 > this.oldHash.indexOf("lg=" + this.core.s.galleryId)
            ? history.replaceState
  ...
  (function (e) {
    ...
    function t(t) {
      ...
      if (
        ...
        "axis" in r && r.axis === r.HORIZONTAL_AXIS && ((h = -1 * u), (u = 0)),
        (d = 0 === u ? h : u),
        "deltaY" in r && (d = u = -1 * r.deltaY),
        "deltaX" in r && ((h = r.deltaX), 0 === u && (d = -1 * h)),
        0 !== u || 0 !== h)
      ) {
        if (1 === r.deltaMode) {
        ...
        if (
          ((g = Math.max(Math.abs(u), Math.abs(h))),
          (!l || l > g) && ((l = g), s(r, g) && (l /= 40)),
          s(r, g) && ((d /= 40), (h /= 40), (u /= 40)),
          ...
          (m = t.clientX - v.left), (p = t.clientY - v.top);
        }
        return (
          (t.deltaX = h),
          (t.deltaY = u),
    ...
    var c = (e.event.special.mousewheel = {
      ...
      teardown: function () {
        if (this.removeEventListener)
          for (var o = a.length; o; ) this.removeEventListener(a[--o], t, !1);
      ...
      getLineHeight: function (t) {
        var o = e(t),
          s = o["offsetParent" in e.fn ? "offsetParent" : "parent"]();
        return (
          s.length || (s = e("body")),
