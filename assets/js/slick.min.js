!(function (i) {
  ...
  ((s =
    ...
    (s.prototype.checkNavigable = function (i) {
      var t, s;
      if (((s = 0), i > (t = this.getNavigableIndexes())[t.length - 1]))
        i = t[t.length - 1];
      else
        for (var e in t) {
          if (i < t[e]) {
    ...
    (s.prototype.lazyLoad = function () {
      ...
      function n(t) {
        i("img[data-lazy]", t).each(function () {
          var t = i(this),
            ...
            n = i(this).attr("data-sizes") || o.$slider.attr("data-sizes"),
      ...
      if (
        ...
        for (
          var l = s - 1, r = e, d = o.$slider.find(".slick-slide"), a = 0;
          a < o.options.slidesToScroll;
          a++
        )
          l < 0 && (l = o.slideCount - 1),
            (t = (t = t.add(d.eq(l))).add(d.eq(r))),
            l--,
            r++;
      n(t),
